...
public partial class BodegaDspContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetalleEmpleado>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdEmpleado, "UQ__DETALLE___922CA2682761B638").IsUnique();
            ...
            entity.HasOne(d => d.IdEmpleadoNavigation).WithOne(p => p.DetalleEmpleado)
                .HasForeignKey<DetalleEmpleado>(d => d.IdEmpleado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_empleado_detalle");
        });
